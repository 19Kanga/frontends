...
const ProductbaseDropdown = () => {
  ...
  return (
    <div className="bg-[#EEEEEE] max-lg:hidden my-15">
      <ul className="flex h-24 items-center  justify-center gap-3 p-0 m-0 text-sm max-sm:gap-4 max-sm:text-[0.8rem]">
        <li
      ...
      <div className="pt-5 px-[3%]">{renderContent()}</div>
    </div>
  );
};
