    ...
    return (
      mattresses.map((item,index)=>(
        ...
        <div className="overflow-hidden rounded-t-xl relative " >
         ...
         : 
         <Link href='/products/[pages]/product/[details]' as={`/products/${pageType}/product/${item.name}`} className="min-w-full cursor-pointer bg-white shadow-md rounded-xl hover:shadow-xl overflow-hidden">
