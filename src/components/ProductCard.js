        ...
        selectedGrid === 0 ? <div className={`flex p-[20px] md:gap-x-4  border border-primary ${index >= 0 && index < 9 ? "border-b-0" : ""} `}>
            ...
            <div className='flex items-center flex-wrap justify-between w-full '>
                {!isMattresses && <div className='text-center pt-3'>
                    <Link href='/products/[pages]/product/[details]' as={`/products/${pageType}/product/${name}`} className=" bg-primary p-3 px-2 xs:ms-[0px] ms-[6px] text-white cursor-pointer rounded-md">
            ...
            <div className='text-center pt-3'>
                {!isMattresses && 
                <Link href='/products/[pages]/product/[details]' as={`/products/${pageType}/product/${name}`} className="byb-badge">
                    <span>Customize your bed</span>
                </Link>}
            </div>
            <div className="px-4 py-3">
