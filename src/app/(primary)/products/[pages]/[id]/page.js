...
const Pages = () => {
    ...
    const {pages,id}=router
    const title= id.replace(/[0-9%]/g, ' ')
    const calling= id.replace(/[0-9%]/g, '')
            ...
            <div>
                ...
                <div className="products-body w-full mt-5 py-10 pb-15 px-[4.3%] ">
                        ...
                        <div className="">
                            ...
                            <div className="drawer-content">
                                <label htmlFor="my-drawer" className="drawer-button">
                                    <div className="filter flex items-center cursor-pointer gap-1 text-gray-400 ">
                    ...
                    <div className="list">
                        ...
                        <ProductListMatress CallingFrom={calling} pageType={pages} selectedGrid={selectedGrid} setSelectedGrid={setSelectedGrid} />
                        }
                    </div>
